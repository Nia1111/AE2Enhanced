...
public class ItemPartEnergyStorageBus extends Item implements IPartItem<PartEnergyStorageBus> {
    ...
    public ItemPartEnergyStorageBus() {
        ...
        this.setTranslationKey("ae2enhanced.part_energy_storage_bus");
        this.setRegistryName("ae2enhanced", "part_energy_storage_bus");
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        tooltip.add(I18n.format("item.ae2enhanced.part_energy_storage_bus.tooltip"));
    }
}
